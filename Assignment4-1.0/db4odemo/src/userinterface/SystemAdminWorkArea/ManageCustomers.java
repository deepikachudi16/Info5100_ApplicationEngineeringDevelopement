...
public class ManageCustomers extends javax.swing.JPanel {
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        Component component = cArray[cArray.length - 1];
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        try {
         ...
         try {
            ...
            if(password==null || password.isEmpty()){
             ...
             JOptionPane.showMessageDialog(null, "Password should consist of atleast a Capital letter, number, special character");
        ...
        UserAccount useraccount =system.getUserAccountDirectory().createUserAccount(name,uname,password, null, new CustomerRole());
        Customer custaccount= system.getCustomerDirectory().createCustomer(uname);
        populateNetworkTable();
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if(selectRow>=0){
            ...
            String pass= (String) networkJTable.getValueAt(selectRow, 2);
            user=system.getUserAccountDirectory().authenticateUser(username, pass);
